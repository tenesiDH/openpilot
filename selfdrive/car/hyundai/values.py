...
class CAR:
  ...
  OPTIMA = "HYUNDAI OPTIMA SX 2019"                   # First User @blender0
...
FEATURES = {
  ...
  "use_cluster_gears": [CAR.ELANTRA, CAR.KIA_SORENTO, CAR.OPTIMA],  # Use Cluster for Gear Selection, rather than Transmission
